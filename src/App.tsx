...
const journeyData: Journey[] = [
  {
    ...
    highlights: [
      'Redesigned a core banking netting engine handling $140M+ monthly intercompany touchpoints with better efficiency and accuracy.',
...
const projects: Project[] = [
  {
    ...
    tag: 'systems',
    company: 'Goldman Sachs',
    impact: '$140M+ monthly banking touchpoints',
    details: 'Reworked banking netting logic and processing strategy to improve correctness and throughput.',
  },
  {
...
function App() {
  ...
  useEffect(() => {
    if (!started) return
    const timer = window.setTimeout(() => setShowChallengePrompt(true), 2800)
  ...
  return (
    <>
      ...
      {showChallengePrompt && (
        <div className="challenge-modal" role="dialog" aria-modal="true" aria-label="Try gamified resume challenge">
          <div className="challenge-card">
            <p className="kicker">New Mode</p>
            <h3>Ready for a challenge?</h3>
            <p>Try the new 3D gamified resume experience.</p>
            <div className="cta-row">
              ...
              <button type="button" className="btn btn-ghost" onClick={() => setShowChallengePrompt(false)}>
                Stay Here
              </button>
            </div>
          </div>
      ...
      {started && !showChallengePrompt && (
        <aside className="challenge-dock">
          <p>Want the full game mode?</p>
          <a className="btn btn-primary" href="/3d-challenge/">
            Launch 3D Challenge
          </a>
        </aside>
      )}
        ...
        <section id="hero" className="panel hero">
          <div className="hero-copy">
            ...
            <div className="quick-badges">
              <span>$140M+ monthly banking touchpoints</span>
